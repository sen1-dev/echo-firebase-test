...
class SubscriptionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(
        child: Text('Subscription paywall placeholder. Unlock unlimited tests!'),
      ),
    );
  }
}

class PlaceholderTestScreen extends StatelessWidget {
  const PlaceholderTestScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('New Test')),
      body: const Center(child: Text('Test screen placeholder.')),
    );
  }
}
